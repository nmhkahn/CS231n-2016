...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    # second fc layer
    W2 = np.random.randn(num_filters*H*W, hidden_dim) * weight_scale 
  ...
  def loss(self, X, y=None):
    ...
    fc2, fc2_cache = affine_relu_forward(conv1, W2, b2)
    fc3, fc3_cache = affine_forward(fc2, W3, b3)
    ...
    dx3, dw3, db3 = affine_backward(dout, fc3_cache)
    dx2, dw2, db2 = affine_relu_backward(dx3, fc2_cache)
    dx1, dw1, db1 = conv_relu_pool_backward(dx2, conv1_cache)
